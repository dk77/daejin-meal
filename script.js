...
const meals = {
  ...
  "2025-10-17":  ["쌀밥","나물비빔밥","아욱된장국","명엽채호두조림","계란후라이","회오리감자튀김","배추김치","두부약고추장","연시1/2"],
  ...
  "2025-10-29": ["쌀밥","가쓰오장국","순대찜","단무지무침","국물떡볶이","김말이튀김","수제야채튀김","배추김치","파인애플"],
  "2025-10-30": ["기장조밥","소면사리","설렁탕","도토리묵야채무침","수제김치전","깍두기","미니버터소금쿠키","야채스틱","쌈장"],
  "2025-10-31": ["쌀밥","짬뽕","해물짬뽕","해파리냉채","짜사이무침","탕수육소스","탕수육","배추김치","푸딩"]
};
